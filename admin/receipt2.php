...
$musa=$_GET['musa'];
$cid=$_GET['cid'];
   $query122=mysqli_query($con,"select * from registration where id='$cid' order by id desc LIMIT 0,1")or die(mysqli_error($con));
      
        $row11=mysqli_fetch_array($query122);
   ...
   $query=mysqli_query($con,"select * from withdraw where id='$musa' order by id desc LIMIT 0,1")or die(mysqli_error($con));
		...
		$amount_removed=$row['amount_removed'];
...
<h4>WITHDRAWAL RECEIPT</h4></b></center></td></tr>
  ...
  <tr><td colspan="2">
      ...
      <tr>
      <td  colspan="2">
            <b style=" font-family:'Courier New', Courier, monospace;">Narration:
                <?php echo $narration; ?> </b>
        </td></tr>
    <tr>
      <td  colspan="2">
            <b style=" font-family:'Courier New', Courier, monospace;">Withdrawal Date:
                <?php echo $date; ?> </b>
        </td></tr>
               <tr>
         <td  colspan="2"><b style=" font-family:'Courier New', Courier, monospace;">Amount Withdrawn:<?php echo strtoupper('N'.$amount_removed); ?></h2></b></td>
        </tr> 
                  <tr>
