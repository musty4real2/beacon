        ...
        <section role="main" class="content-body">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">List of all Transfer Made Today (<?php echo $date; ?>)&nbsp;</h2> <br/>
                </header>
                <!-- Modal Form -->
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped mb-none" id="datatable-default">
                        ...
                        <?php
                        $t=1;
                        $query=mysqli_query($con,"select * from otherbank WHERE status='pending' AND entry_date='$date' order by id DESC")
...
$msg="Reciever Account Name {$row['account_name']}, Account Number {$row['account_number']}, Transfer Amount $ccur{$row['transfer_amount']}, Transfer Bank {$row['bankname']}, Sortcode / ABA code {$row['sortcode']}";
                        ...
                        <tr class="gradeX">
                            ...
                            <form action='transferstatus.php' method='post'>
        ...
        <input type='hidden' name='email' value='<?php echo ucfirst($object->getCustemail($row['user_id'],$con)); ?>'/> 
                ...
                <input type="hidden" name='msg' value='<?php echo $msg; ?>'/>
                           ...
                           <button type="submit" class="btn btn-success">Change Status</button>
                            ...
                            <td class="center">
                                <form action='transferdelete.php' method='post'>
