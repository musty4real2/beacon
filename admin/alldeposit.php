            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped mb-none" id="datatable-default">
                        ...
                        <?php
                        $t=1;
                        $query=mysqli_query($con,"select * from deposit order by deposit_id DESC")
                        ...
                        <tr class="gradeX">
                            <td><?php echo $t++; ?></td>
                            <td><a class="text" href="viewprofile.php?userid=<?php echo $row['cust_id']; ?>"><?php echo ucfirst($object->getCustName($row['cust_id'],$con)); ?></a></td>
