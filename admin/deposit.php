                    ...
                    <table class="table table-bordered table-striped mb-none" id="datatable-default">
                        ...
                        <tr class="gradeX">
                            ...
                            <td> <a href="#modalForm<?php echo $row['id'];?>"
                                   class="modal-with-form btn btn-success btn-sm">
                                    Make Deposit
                                </a>
                            </td>
                        </tr>
                        ...
                        <div id="modalForm<?php echo $row['id'];?>" class="modal-block modal-block-primary mfp-hide">
                            <section class="panel">
                                <header class="panel-heading">
                                    <h2 class="panel-title">Make Deposit For <?php echo strtoupper($row['first_name'].' '.$row['middle_name'].' '.$row['lasst_name']);?></h2>
                                </header>
                                <div class="panel-body">
                                    <form action="deposit_add.php" class="form-horizontal mb-lg" enctype="multipart/form-data" method="post">
                                        <div class="form-group mt-lg">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="amount" class="form-control" placeholder="Type in deposit amount...e.g 10000" required/>
                                            </div>
                                        </div>
